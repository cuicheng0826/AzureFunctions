...
namespace FileFunctions
{
    ...
    string userAgent = null, CookieCollection cookies = null, IDictionary<string, string> heads = null, string type = null, string value = null, bool isThrow = false)
        ...
        public static string SendRequest(this string url, SortedDictionary<string, object> requestParams, string fileName = null)
        {
        ...
        public static string SendCOSRequest(string url, ref Dictionary<string, object> data, HttpMethod requestMethod,
            ref Dictionary<string, string> header, int timeOut, byte[] fileContent, string fileName, long offset = -1, int sliceSize = 0)
        {
            try
            {
